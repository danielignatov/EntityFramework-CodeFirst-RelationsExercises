namespace StudentSystem.Data
{
    ...
    class StudentSystemInitializer : DropCreateDatabaseIfModelChanges<StudentSystemContext>
    {
        protected override void Seed(StudentSystemContext context)
        {
            ...
            License openLicense = new License()
            {
                Id = 1,
                Name = "Open License"
            };

            context.Licenses.Add(openLicense);
            ...
            foreach (var resource in resources)
            {
                ...
                resource.Licenses.Add(openLicense);
            }
